  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="lg:pl-72">
        ...
        {/* Mobile Profile Menu */}
        {showProfileMenu && (
          <div className="lg:hidden absolute top-16 right-4 left-4 z-50 bg-white/95 backdrop-blur-2xl rounded-2xl shadow-2xl border border-white/30 overflow-hidden animate-fade-in">
            <div className="p-4 space-y-2">
              <button
                ...
                className="w-full flex items-center px-4 py-3 text-sm font-bold text-gray-700 rounded-xl hover:bg-blue-50 hover:text-blue-700 transition-all duration-200"
              >
              ...
              <button
                ...
                className="w-full flex items-center px-4 py-3 text-sm font-bold text-gray-700 rounded-xl hover:bg-green-50 hover:text-green-700 transition-all duration-200"
              >
              ...
              <button
                onClick={handleLogout}
                className="w-full flex items-center px-4 py-3 text-sm font-bold text-red-600 rounded-xl hover:bg-red-50 transition-all duration-200"
              >
