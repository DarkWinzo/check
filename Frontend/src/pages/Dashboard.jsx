...
import { studentsAPI, coursesAPI, registrationsAPI, authAPI } from '../services/api'
import { 
  Users, 
  BookOpen, 
  GraduationCap, 
...
const Dashboard = () => {
  ...
  const [systemInfo, setSystemInfo] = useState({
    ...
    performance: {
      ...
      network: 'Fast',
      networkSpeed: Math.floor(Math.random() * 30) + 70 // 70-100%
    },
    status: {
      database: 'connected',
      api: 'responsive',
  ...
  const fetchDashboardData = async (silent = false) => {
    try {
      ...
      setSystemInfo(prev => ({
        ...prev,
        totalRecords: students.length + courses.length,
        lastUpdated: new Date(),
        refreshRate: autoRefreshEnabled ? '30s' : 'Manual',
        performance: {
          ...prev.performance,
          cpu: Math.floor(Math.random() * 30) + 15,
          memory: Math.floor(Math.random() * 40) + 50,
          networkSpeed: Math.floor(Math.random() * 30) + 70
        }
      }))
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-tr from-cyan-500/10 via-blue-500/10 to-purple-500/10 rounded-3xl"></div>
          
          {/* Animated Background Orbs */}
          <div className="absolute top-4 left-4 w-32 h-32 bg-gradient-to-r from-blue-400/20 to-cyan-500/20 rounded-full blur-xl animate-pulse"></div>
          <div className="absolute bottom-4 right-4 w-40 h-40 bg-gradient-to-r from-purple-400/20 to-blue-500/20 rounded-full blur-xl animate-pulse" style={{ animationDelay: '1s' }}></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-24 h-24 bg-gradient-to-r from-cyan-400/20 to-purple-500/20 rounded-full blur-xl animate-pulse" style={{ animationDelay: '2s' }}></div>
          ...
          <div className="relative bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-2xl p-8">
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center space-x-4">
                <div className="relative">
                  {/* Glowing Ring */}
                  <div className="absolute -inset-2 bg-gradient-to-r from-blue-500 via-cyan-500 to-purple-500 rounded-full opacity-20 animate-spin" style={{ animationDuration: '3s' }}></div>
                  <div className="relative p-3 bg-gradient-to-br from-white/20 to-white/5 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl">
                    <Activity className="h-7 w-7 text-cyan-400 drop-shadow-lg animate-pulse" />
                  </div>
                </div>
                <div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="text-right">
                  <div className="text-cyan-300 font-bold text-sm">All Systems Operational</div>
                  <div className="text-white/50 text-xs">Last checked: {systemInfo.lastUpdated.toLocaleTimeString()}</div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="group relative">
                ...
                <div className="relative bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6 shadow-2xl hover:shadow-cyan-500/25 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105">
                  <div className="flex items-center justify-between mb-4">
                    <div className="p-2 bg-cyan-500/20 rounded-xl">
                      <Activity className="h-5 w-5 text-cyan-400" />
                    </div>
                    <div className="text-xs text-cyan-300 font-semibold bg-cyan-500/20 px-2 py-1 rounded-full">
                      EXCELLENT
                    </div>
                  </div>
                  <div className="text-center">
                    ...
                    <div className="mt-3 w-full bg-white/10 rounded-full h-2">
                      <div className="bg-gradient-to-r from-cyan-400 to-blue-400 h-2 rounded-full animate-pulse" style={{ width: '99.9%' }}></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Total Records Card */}
              <div className="group relative">
                <div className="absolute -inset-1 bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl blur opacity-25 group-hover:opacity-40 transition duration-1000 group-hover:duration-200"></div>
                <div className="relative bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6 shadow-2xl hover:shadow-blue-500/25 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105">
                  ...
                  <div className="text-center">
                    <div className="text-3xl font-black text-white mb-2 bg-gradient-to-r from-blue-300 to-cyan-300 bg-clip-text text-transparent">
                      {systemInfo.totalRecords.toLocaleString()}
                    </div>
              ...
              {/* Last Updated Card */}
              <div className="group relative">
                <div className="absolute -inset-1 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-2xl blur opacity-25 group-hover:opacity-40 transition duration-1000 group-hover:duration-200"></div>
                <div className="relative bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6 shadow-2xl hover:shadow-cyan-500/25 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105">
                  <div className="flex items-center justify-between mb-4">
                    <div className="p-2 bg-cyan-500/20 rounded-xl">
                  ...
                  <div className="text-center">
                    <div className="text-lg font-black text-white mb-2 bg-gradient-to-r from-cyan-300 to-purple-300 bg-clip-text text-transparent font-mono">
                      {systemInfo.lastUpdated.toLocaleTimeString()}
                    </div>
                    ...
                    <div className="mt-3 flex items-center justify-center">
                      <div className="relative">
                        ...
                        <div className="absolute inset-0 w-6 h-6 border-t-2 border-purple-400 rounded-full animate-spin" style={{ animationDirection: 'reverse', animationDuration: '0.8s' }}></div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-blue-300 font-bold">{systemInfo.performance.cpu}%</span>
                </div>
                <div className="w-full bg-white/10 rounded-full h-3 mb-2">
                  <div className="bg-gradient-to-r from-blue-500 to-cyan-400 h-3 rounded-full animate-pulse" style={{ width: `${systemInfo.performance.cpu}%` }}></div>
                </div>
              ...
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-purple-300 font-bold">{systemInfo.performance.memory}%</span>
                </div>
                <div className="w-full bg-white/10 rounded-full h-3 mb-2">
                  <div className="bg-gradient-to-r from-purple-500 to-blue-400 h-3 rounded-full animate-pulse" style={{ width: `${systemInfo.performance.memory}%` }}></div>
                </div>
              ...
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-cyan-300 font-bold">{systemInfo.performance.network}</span>
                </div>
                <div className="flex items-center space-x-2 mb-2">
                  <div className="flex-1 bg-white/10 rounded-full h-3">
                    <div className="bg-gradient-to-r from-cyan-500 to-blue-400 h-3 rounded-full animate-pulse" style={{ width: `${systemInfo.performance.networkSpeed}%` }}></div>
                  </div>
                </div>
            ...
            <div className="mt-8 flex items-center justify-between">
              <div className="flex items-center space-x-4">
                <div className="flex items-center space-x-2 text-white/60 text-sm">
                  ...
                  <span>System {systemInfo.status.system}</span>
                </div>
                <div className="flex items-center space-x-2 text-white/60 text-sm">
                  <div className="w-2 h-2 bg-blue-400 rounded-full animate-pulse"></div>
                  <span>Database {systemInfo.status.database}</span>
                </div>
                <div className="flex items-center space-x-2 text-white/60 text-sm">
                  <div className="w-2 h-2 bg-purple-400 rounded-full animate-pulse"></div>
                  <span>API {systemInfo.status.api}</span>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <button
                  onClick={handleRefresh}
                  disabled={refreshing}
                  className="px-4 py-2 bg-gradient-to-r from-blue-500 to-cyan-600 hover:from-blue-600 hover:to-cyan-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 disabled:opacity-50 flex items-center space-x-2"
                >
                  <RefreshCw className={`h-4 w-4 ${refreshing ? 'animate-spin' : ''}`} />
